...
<body class="body">
    ...
    <div class="container-3 w-container">
      <div class="w-layout-grid grid">
        <div id="w-node-b697e036-735e-08c0-bc5b-b13cca0d2141-9d8417b5">
          ...
          <div class="html-embed w-embed">Online: <span id="online-clients"></span>/64</div><br>
  ...
  <!-- [if lte IE 9]><script src="https://cdnjs.cloudflare.com/ajax/libs/placeholders/3.0.2/placeholders.min.js"></script><![endif] -->
    <script>
    // Fetch JSON data
    fetch('http:/14.102.233.236:30120/dynamic.json')
        .then(response => response.json())
        .then(data => {
            // Extract required information
            const clients = data.clients;

            // Update DOM with the retrieved data
            document.getElementById('online-clients').textContent = clients;
        })
